export type LogType = "application" | "backend" | "backendCache" | "backend_queue" | "errors" | "files-checker" | "insurance" | "inventory" | "network-connection" | "network-messages" | "objectPool" | "output" | "player" | "push-notifications" | "seasons" | "spatial-audio" | "aiData" | "aiErrors";
...
export interface ApplicationLogEvent extends BaseLogEvent<"application"> {
    ...
    eventFamily: "bootstrap" | "gc" | "config" | "anticheat" | "instrumentation" | "matchmaking" | "error" | "other";
    fields?: {
        profileId?: string;
        accountId?: string;
        groupId?: string;
...
export interface BackendLogEvent extends BaseLogEvent<"backend"> {
    eventFamily: "request" | "response" | "transport_error" | "retry" | "deserialization_error" | "server_exception" | "other";
    fields?: {
        id?: number;
        url?: string;
        crc?: string;
...
export interface ErrorsLogEvent extends BaseLogEvent<"errors"> {
    eventFamily: "mip_timeout" | "null_reference" | "key_not_found" | "missing_lamp" | "missing_quest_counter" | "seasons" | "locale_duplicate" | "enum_fallback" | "serialization_layout" | "supply_data_null" | "spatial_audio" | "resource_null" | "duplicate_object" | "insurance" | "ai" | "player" | "other";
    fields?: Record<string, unknown>;
}
...
export interface NetworkConnectionLogEvent extends BaseLogEvent<"network-connection"> {
    eventFamily: "connect" | "disconnect" | "send_disconnect" | "statistics" | "state_enter" | "state_exit" | "send_connect" | "timeout" | "thread_aborted" | "other";
    fields?: {
        address?: string;
        state?: string;
        syn?: boolean;
...
export interface SpatialAudioLogEvent extends BaseLogEvent<"spatial-audio"> {
    eventFamily: "init_success" | "system_initialized" | "target_quality" | "dsp_stats" | "reverb_checker" | "reverb_reset" | "occlusion_error" | "other";
    fields?: {
        quality?: string;
...
export type AnyLogEvent = ApplicationLogEvent | BackendLogEvent | BackendCacheLogEvent | BackendQueueLogEvent | ErrorsLogEvent | FilesCheckerLogEvent | InsuranceLogEvent | InventoryLogEvent | NetworkConnectionLogEvent | NetworkMessagesLogEvent | ObjectPoolLogEvent | OutputLogEvent | PlayerLogEvent | PushNotificationsLogEvent | SeasonsLogEvent | SpatialAudioLogEvent | AiDataLogEvent | AiErrorsLogEvent;
